...
export const CATEGORIES: Category[] = [
  {
    ...
    seeds: [
      ...
      "planning, reflection, and retry loops",
      "tool-use vs pure reasoning tradeoffs",
      "long-horizon agent tasks",
      "agent sandboxes and permissions",
      "multi-agent debate and critique",
      "memory stores for agents (vector + episodic)",
      "agent orchestration frameworks",
      "browser/OS control agents",
      "agent failure modes and recovery",
      "evals for agentic systems",
      "cost and latency of agent loops",
      "delegation between specialized agents",
      "agents writing and running code",
      "agent security and prompt injection",
      // Frontier AI / AGI-adjacent
      "AGI definitions and moving goalposts",
      "pathways to AGI (scaling vs new paradigms)",
      "intelligence explosion arguments",
      "recursive self-improvement debates",
      "capability overhang and sudden jumps",
      "world models and predictive agents",
      "continuous learning after deployment",
      "test-time compute / inference scaling",
      "reasoning models and chain-of-thought",
      "scaffolding vs raw model capability",
      "tool-augmented intelligence",
      "open-endedness and novelty search",
      "embodiment and AGI",
      "AI scientists and automated discovery",
      "alignment under agentic autonomy",
      "corrigibility and shutdown problems",
      "deceptive alignment (plain spoken)",
      "mechanistic interpretability frontiers",
      "model organisms of misalignment",
      "AI governance for frontier models",
      "compute governance and cluster politics",
      "synthetic data flywheels",
      "superintelligence timelines debates",
      "human-AI coevolution of work",
      ...
      "KV-cache and long-context engineering",
      "mixture-of-agents inference",
      "process vs outcome supervision",
      "constitutional AI and self-critique",
      "retrieval-augmented generation failure modes",
      "multimodal grounding problems",
      "video and audio understanding frontiers",
      ...
      "teleoperation to autonomy pipelines",
      ...
      "AI inference serving stacks",
      "chip wars and custom accelerators",
      // Quant & markets
